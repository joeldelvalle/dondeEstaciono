 ...
 * 
 *         restful que se utiliza para borrar informacion proveniente de la web
 *         y mobile
 * 
 */
@Component
@Path("/delete")
public class DeleteInformationRest extends SecureRest {
	...
	public String delete(String json, @PathParam("objectToDelete") String objectToDelete) {
		...
		try {
			...
			GenericBean bean = this.appContextService.getCustomBean(this.createBeanName(objectToDelete));
			...
			bean.deleteValidation(genericModel);
