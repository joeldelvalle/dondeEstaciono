 ...
 */
public class FindByProvinceLocalityRestTest {
	...
	public static void main(String[] args) {
		...
		try {
			...
			WebResource webResource = client.resource("http://localhost:8080/DondeEstacionoServer/rest/application/list/locality/1");
